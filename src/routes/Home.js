...
const Home = () => {
    return (
        <Container>
        <Stack gap={20}>
            <Stack direction='row' spacing={10} alignItems={'center'} sx={{height: '80vh'}}>
                ...
                <Stack gap={2}>
                    <Stack direction='row' spacing={3} alignItems={'center'}>
                        ...
                        <Chip label="FRONT-END ENGINEERING" variant="outlined" color="primary" />
                    </Stack>

                    <Typography variant="h4" component="h2" gutterBottom align='left' sx={{
                        'b' : {
                    ...
                    <Stack direction='row' spacing={3} alignItems={'center'} sx={{paddingTop: '12px'}}>
